...
<head>
    ...
    <style>
        ...
        body.login .login-sidebar {
            border-top:5px solid {{ config('voyager.primary_color','#E67052') }};
        }
        @media (max-width: 767px) {
            body.login .login-sidebar {
                border-top:0px !important;
                border-left:5px solid {{ config('voyager.primary_color','#E67052') }};
            }
        }
        body.login .form-group-default.focused{
            border-color:{{ config('voyager.primary_color','#E67052') }};
        }
        .login-button, .bar:before, .bar:after{
            background:{{ config('voyager.primary_color','#E67052') }};
        }
        .remember-me-text{
            padding:0 5px;
        }
